...
import { TextPartLanguageCommand } from "@gugler/textpartlanguagecommand";
import {
  stringifyLanguageAttribute,
  parseLanguageAttribute,
} from "@gugler/ckeditor-language-utils";
/**
...
class TextPartLanguageEditing extends Plugin {
  ...
  init() {
    ...
    editor.commands.add(
      "textPartLanguage",
      new TextPartLanguageCommand(editor),
    );
  }
  /**
   * @private
...
export { TextPartLanguageEditing };
